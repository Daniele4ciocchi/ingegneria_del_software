...
#define PG_VERSION "17.2 (Ubuntu 17.2-1.pgdg22.04+1)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 170002

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 17.2 (Ubuntu 17.2-1.pgdg22.04+1) on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0, 64-bit"
