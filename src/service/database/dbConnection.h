...
#include "../../lib/postgresql/libpq-fe.h"  // libreria libpq, utilizzata per la connessione al db Postgres
// per farlo funzionare ricordate di installare questa libreria.
// il comando e':  sudo apt-get install libpq-dev
// potrebbe funzionare anche cosi: #include "../../lib/postgresql/libpq-fe.h"
