...
int main() {
    ...
    while(1) {
        ...
        // Convert request
        try {
            specializzazione = Specializzazione::from_stream(reply, 0, 0);
        }
        ...
        // Construct the query
        query = "INSERT INTO specializzazioni (medico_id, specializzazione) VALUES (" + 
                specializzazione->medico_id + ", '" + specializzazione->nome + "')";
